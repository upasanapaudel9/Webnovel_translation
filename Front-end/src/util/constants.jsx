...
export const novelDetailedView = '/novel-detailed';
...
export const authorAddChapter = '/author/novels/add-chapter';
export const authorEditChapter = '/author/novels/edit-chapter';
export const authorEditNovel = '/author/novels/edit-novel';
...
export const getMostViewedPost = '/get-most-viewed';
export const getTrendingPost = '/get-trending';
export const getNewUpdatedPost = '/get-new-updated';
