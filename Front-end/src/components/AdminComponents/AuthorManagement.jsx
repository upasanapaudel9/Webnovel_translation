...
export default function AuthorManagement() {
    ...
    return (
        <div className='ml-80 m-10'>
            <h1 className='m-10 font-mono font-extrabold text-sm md:text-3xl'>Translator Management</h1>
            <br />
            {
                ...
                </div> : <p className='text-2xl rounded-lg text-white font-bold font-mono bg-blue-300'>There is no translators</p>
            }
