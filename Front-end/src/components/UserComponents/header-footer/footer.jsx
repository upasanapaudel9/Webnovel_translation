            ...
            <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
                <div className="sm:flex sm:items-center sm:justify-between">
                    <p className="flex items-center mb-4 sm:mb-0 space-x-3 rtl:space-x-reverse">
                        <img src="/assets/logo/webLogo.png" className="h-12 mt-3 hover:animate-bounce" alt="TheCollabTranslate Logo" />
                        <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">TheCollabTranslate</span>
                    </p>
                        ...
                        <li>
                            ...
                            <dialog id="my_modal_1" className="modal rounded-2xl w-1/2">
                                <div className="modal-box p-5 bg-gray-600">
                                    ...
                                    <p className="py-4 text-white">Welcome to TheCollabTranslate! We're dedicated to creating a vibrant community
                                    ...
                                    <h3 className="font-bold text-gray-400 mb-5">Join us on TheCollabTranslate and embark on a literary journey!</h3>
                ...
                <span className="block text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2025 TheCollabTranslate. All rights reserved.</span>
            </div>
        </footer >
